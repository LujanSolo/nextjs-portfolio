...
const ItemLayout = ({ children, className }) => {
  return <div className={clsx("custom-bg-alt p-8 rounded-xl items-center justify-center space-y-8", className)}>
    {children}
  </div>
}
  ...
  return (
    <section className="py-20 w-full">
      <div className="grid grid-cols-12 gap-8 w-full">
        <ItemLayout className={"xs:col-span-full lg:col-span-6 row-span-2 flex-col items-start"}>
        ...
        <ItemLayout className={"xs:col-span-full lg:col-span-6 text-accent flex"}>
          <p className="font-semibold w-full lg:text-left text-5xl text-center">
            100's <sub className="font-semibold text-base">of students taught</sub>
          </p>

        </ItemLayout><ItemLayout className={"xs:col-span-full lg:col-span-6 text-accent flex"}>
          <p className="font-semibold w-full lg:text-left text-center text-5xl">
        ...
        <ItemLayout className={"xs:col-span-full lg:col-span-4 !p-0"}>
        ...
        <ItemLayout className={"xs:col-span-full lg:col-span-8 !p-0"}>
        ...
        <ItemLayout className={"xs:col-span-full lg:col-span-6 !p-0"}>
